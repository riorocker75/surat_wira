...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Ubah Surat Kematian</h1>
		...
		<div class="row">
            <div class="col-lg-12 mb-4">
                <div class="card shadow mb-4">
                    ...
                    <form action="<?php echo base_url().'admin/surat_mati_update'?>" method="post" enctype='multipart/form-data'>
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="nama_meninggal" value="<?php echo $dt->nama_meninggal?>">
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="nik" value="<?php echo $dt->nik?>">
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="pelapor" value="<?php echo $dt->pelapor ?>">
                                </div>
