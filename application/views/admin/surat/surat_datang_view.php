                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="no_surat_pindah" value="<?php echo $dt->no_surat_pindah ?>" disabled>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="nama_datang" value="<?php echo $dt->nama_datang ?>" disabled>
                                 ...
                                 <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="tmp_tgl_lhr" value="<?php echo $dt->tmp_tgl_lhr ?>" disabled>
                            ...
                            <div class="col-lg-6">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="daerah_asal" value="<?php echo $dt->daerah_asal ?>" disabled>
