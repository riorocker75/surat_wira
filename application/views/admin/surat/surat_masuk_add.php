		...
		<div class="row">
            <div class="col-lg-12 mb-4">
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                    <form action="<?php echo base_url().'admin/surat_masuk_act'?>" method="post" enctype='multipart/form-data'>
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-lg-6">
                                    ...
                                    <input type="date" class="form-control form-control-user" name="tgl_masuk" value="<?php echo date("Y-m-d");?>">
                                </div>
