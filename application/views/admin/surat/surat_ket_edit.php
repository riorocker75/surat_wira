...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
  <h1 class="h3 mb-0 text-gray-800">Ubah Data Surat Keterangan Desa Kebun Balok</h1>
		...
		<div class="row">
            <div class="col-lg-12 mb-4">
                <div class="card shadow mb-4">
                    ...
                    <form action="<?php echo base_url().'admin/surat_ket_update'?>" method="post" enctype='multipart/form-data'>
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="form-group">
                                    <label for="">Jenis Surat</label>
                                    <input type="text" class="form-control form-control-user" name="jenis_surat" value="<?php echo $dt->jenis_surat?> ">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control form-control-user" name="pemohon" value="<?php echo $dt->pemohon?> ">
                                    ...
                                    <textarea name="keperluan"  cols="20" rows="10" class="form-control form-control-user" ><?php echo $dt->keperluan?> </textarea>
